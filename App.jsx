import {faHome, faPlayCircle} from '@fortawesome/free-solid-svg-icons'; // Corrected icon import
      ...
      <Tab.Navigator
        ...
        <Tab.Screen
          ...
          options={{
            ...
            tabBarIcon: ({color}) => {
              return (
                <FontAwesomeIcon icon={faHome} size={20} color={VIOLET_COLOR} />
              );
            },
            tabBarLabel: '', // This line will hide the tab name
